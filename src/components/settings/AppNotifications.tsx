            ...
            {rules.length > 0 && (
                <div className="flex flex-col gap-2">
                    {rules.map(rule => (
                        <div
                            key={rule.app_name}
                            className="flex items-start gap-3 bg-neutral-800 border border-white/5 shadow-sm rounded-xl px-3 py-2.5"
                        >
            ...
            <div className="flex flex-col gap-2 bg-neutral-900 border border-white/10 rounded-xl px-3 py-3">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="bg-neutral-800 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white placeholder-white/20 outline-none focus:border-purple-500/60 transition-colors shadow-sm"
                    />
                ...
                <div className="flex gap-2">
                    <div className="flex flex-col gap-1 flex-1">
                        ...
                        <input
                            ...
                            className="bg-neutral-800 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white outline-none focus:border-purple-500/60 transition-colors shadow-sm"
                        />
                    </div>
                    <div className="flex flex-col gap-1 flex-1">
